...
class AppFileVideoWidget extends StatefulWidget {
  ...
  @override
  State<AppFileVideoWidget> createState() => _AppFileVideoWidgetState();
}

class _AppFileVideoWidgetState extends State<AppFileVideoWidget> {
