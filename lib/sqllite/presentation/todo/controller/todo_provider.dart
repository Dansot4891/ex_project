...
@riverpod
class TodoProvider extends _$TodoProvider {
  final _todoDatabase = TodoDatabaseImpl(AppDb.instance);
  ...
  Future<void> addTodo() async {
    ...
    await _todoDatabase.addTodo(todo);
    ref.invalidateSelf();
  }

  Future<void> deleteTodo(int todoId) async {
    await _todoDatabase.deleteTodo(todoId);
    ref.invalidateSelf();
  }
  ...
  Future<void> editTodo(int todoId) async {
    ...
    await _todoDatabase.editTodo(todoId: todoId, todo: todo);
    ref.invalidateSelf();
  }
}
